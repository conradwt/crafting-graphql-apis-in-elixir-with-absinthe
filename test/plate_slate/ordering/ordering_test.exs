defmodule PlateSlate.OrderingTest do
  ...
  describe "orders" do
    ...
    @valid_attrs %{customer_number: 42, items: %{}, ordered_at: "2010-04-17T14:00:00Z", state: "some state"}
    @update_attrs %{customer_number: 43, items: %{}, ordered_at: "2011-05-18T15:01:01Z", state: "some updated state"}
